...
public class Passenger extends Person{
  ...
  // private components.car.Taxi taxi;
  ...
  public Passenger(int x, int y, int priority, int endx, int endy) {
    ...
    this.radius = Double.parseDouble(st.gameProps.getProperty("gameObjects.passenger.radius"));
    ...
    this.health = Double.parseDouble(st.gameProps.getProperty("gameObjects.passenger.health"));
